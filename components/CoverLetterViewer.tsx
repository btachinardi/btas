...
import coverLetterContent from '../../cover-letter.md?raw';
...
const CoverLetterViewer: React.FC = () => {
  ...
  const handleDownload = () => {
    ...
    a.href = url;
    a.download = 'Bruno_Tachinardi_Cover_Letter.md';
  ...
  return (
    <div className="bg-dark min-h-screen text-slate-200">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-semibold text-white">Cover Letter</h1>
            </div>
      ...
      <main className="container mx-auto px-6 py-8 print:py-0 print:px-0">
        ...
        >
          <MarkdownViewer content={coverLetterContent} />
        </motion.div>
      </main>
